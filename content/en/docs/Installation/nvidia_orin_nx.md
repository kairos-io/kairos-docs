...
Depending on the JetPack version you choose, the Orin NX will work with certain Ubuntu versions (see (https://developer.nvidia.com/embedded/jetpack-archive)[here]).
{{% /alert %}}
