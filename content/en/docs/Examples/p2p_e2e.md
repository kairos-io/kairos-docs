...
We now can run [AuroraBoot]({{< relref "../reference/auroraboot" >}}) with {{<ociCode variant="standard">}} to provision `openSUSE Leap` machines with those k3s and kairos versions.
