...
:::note
The Helm chart was added in [kairos-operator#137](https://github.com/kairos-io/kairos-operator/pull/137) and is published to GHCR from **v0.2.1** onward. If you are pinning to an earlier release, use Option B instead.
:::
