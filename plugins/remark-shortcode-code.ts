...
const SUPPORTED_SHORTCODE_PATTERN = /(\{\{<\s*(Image\b[^>]*|OCI\b[^>]*|FlavorCode|FlavorReleaseCode|RegistryURL|KairosVersion|K3sVersion|K3sVersionOCI|ProviderVersion|KairosInitVersion|AuroraBootVersion|OperatorVersion|OperatorChartVersion|GoogleVersion|OCITag)\s*>\}\}|<\s*ProviderVersion\s*\/>)/;
