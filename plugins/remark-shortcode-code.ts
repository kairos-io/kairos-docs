...
const SUPPORTED_SHORTCODE_PATTERN = /\{\{<\s*(image\b[^>]*|oci\b[^>]*|flavorCode|flavorReleaseCode|registryURL|kairosVersion|providerVersion|kairosInitVersion|auroraBootVersion)\s*>\}\}/;
