...
We now can run [AuroraBoot](/docs/reference/auroraboot) with <OCICode variant="standard" /> to provision `openSUSE Leap` machines with those k3s and kairos versions.
