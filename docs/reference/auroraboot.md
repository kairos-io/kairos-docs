...
Use cases include bundling [system extensions for Trusted Boot](/docs/installation/trustedboot/) images and shipping extra files that are needed during installation but should not be part of the final OS.
