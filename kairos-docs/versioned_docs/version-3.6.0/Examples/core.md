...
install:
 ...
 source: "docker:quay.io/kairos/kairos-standard:latest"
```


:::note Note

Looking to install from a private registry OCI image? Check the [Private registry auth](../../Advanced/private_registry_auth) page.

:::



Once you've chosen your image, you can move on to the installation process by following the steps outlined in our [Installation](../../installation/) documentation.
...
- We set `install.source` to the container image that we want to deploy. This can be an image from [our support matrix](../../reference/image_matrix), a [custom image](../../advanced/customizing) or an [image from scratch](../../reference/build-from-scratch).
...
You can also refer our [troubleshooting](../../reference/troubleshooting) document if you are facing any issue while following the installation process.
