...
- [Upgrading Kairos with the operator](/docs/v3.7.2/upgrade/kubernetes/)
- [Trusted Boot upgrades](/docs/v3.7.2/upgrade/trustedboot/)
- [Manual upgrades](/docs/v3.7.2/upgrade/manual/)
