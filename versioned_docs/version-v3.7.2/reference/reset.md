...
The [Kairos operator](/docs/v3.7.2/upgrade/kairos-operator/) can be used to apply a NodeOp to the nodes to use Kubernetes to schedule the reset on the nodes itself, similarly on how upgrades are applied.
