...
You can read more [here](/docs/v3.7.2/advanced/sys-extensions/).
...
Bundles can carry also binaries that can be overlayed in the rootfs while [building images](/docs/v3.7.2/advanced/build/).
