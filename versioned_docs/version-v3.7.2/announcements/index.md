...
:::note Config dirs read ordering
Starting on v3.2.0, we have agreed on the order the config dirs are read upon. See the [cloud-config](/docs/v3.7.2/architecture/cloud-init/#configuration-order) page for more info.
:::

:::info Remarkable Changes
