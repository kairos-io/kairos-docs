...
The WebUI has an input form that accepts the `YAML` config file, features a syntax highlighter and a `YAML` syntax checker. You can find a [full example in our documentation](/docs/v3.5.7/reference/configuration/) or navigate to our [examples section](/docs/v3.5.7/examples/).
