...
If you want to create an [airgap K3s installation](https://docs.k3s.io/installation/airgap), Kairos provides a convenient way to do so using AuroraBoot. In this guide, we will go through the process of creating a custom ISO of Kairos that contains a configuration file and a [bundle](/docs/v3.5.7/advanced/bundles/) that executes preparatory steps after installation. The bundle will overlay new files in the system and prepare the node for having an airgapped K3s installation.
...
2. Build the ISO with [AuroraBoot](/docs/v3.5.7/reference/auroraboot/) by running the following command:
...
- [Customize the OS image](/docs/v3.5.7/advanced/customizing/)
- [Create ISOs with Kubernetes](/docs/v3.5.7/installation/automated/#kubernetes)
- [Bundles reference](/docs/v3.5.7/advanced/bundles/)
- [System extensions](/docs/v3.5.7/advanced/sys-extensions/)
