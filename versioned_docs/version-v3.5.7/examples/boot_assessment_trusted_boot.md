...
For more information about cloud-init in Kairos, see the [Cloud-Init Architecture](/docs/v3.5.7/architecture/cloud-init/) guide.
For more information about stage modules, see the [Stage Modules Reference](/docs/v3.5.7/reference/stage_modules/).
