...
The Kairos operator needs to be deployed on the target cluster. [Read the instructions here](/docs/v3.5.7/upgrade/kairos-operator/)
...
To install Kyverno in a Kairos cluster, you can simply use the community [bundles](/docs/v3.5.7/advanced/bundles/). For example, you can use the following installation cloud config file:
...
This configuration file prepares the system with the `cert-manager` and `kyverno` bundles, enabling `k3s`. The Kairos operator can be deployed separately using the instructions in the [Kairos Operator documentation](/docs/v3.5.7/upgrade/kairos-operator/).
...
- [Upgrade nodes manually](/docs/v3.5.7/upgrade/manual/)
- [Immutable architecture](/docs/v3.5.7/architecture/immutable/)
- [Create decentralized clusters](/docs/v3.5.7/installation/p2p/)
