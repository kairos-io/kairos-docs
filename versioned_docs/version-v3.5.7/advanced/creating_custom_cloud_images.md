...
See the [Customizing Images](/docs/v3.5.7/advanced/customizing/) guide for detailed instructions.
...
:::info Note
For more details about AuroraBoot options and configurations, see the [AuroraBoot documentation](/docs/v3.5.7/reference/auroraboot/).
:::
...
### AWS
To install on AWS, follow the [AWS Guide](/docs/v3.5.7/installation/aws/).

### Google Cloud
To install on Google Cloud, follow the [Google Cloud Installation Guide](/docs/v3.5.7/installation/gce/).

### Microsoft Azure
For Azure deployments, see the [Azure Installation Guide](/docs/v3.5.7/installation/azure/).
...
- [Customizing Images](/docs/v3.5.7/advanced/customizing/)
- [AuroraBoot Reference](/docs/v3.5.7/reference/auroraboot/)
- [Cloud Configuration Reference](/docs/v3.5.7/reference/configuration/) 