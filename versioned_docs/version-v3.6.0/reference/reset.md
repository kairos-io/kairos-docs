...
The [Kairos operator](/docs/v3.6.0/upgrade/kairos-operator/) can be used to apply a NodeOp to the nodes to use Kubernetes to schedule the reset on the nodes itself, similarly on how upgrades are applied.
