...
- `kairos-ubuntu-23.04-core-amd64-generic-v3.6.0`
- `kairos-ubuntu-23.04-standard-arm64-rpi4-v3.6.0-k3sv1.28.2+k3s1.iso`
...
- `kairos-ubuntu-23.04-core-amd64-generic-v3.6.0-kernel`
- `kairos-ubuntu-23.04-standard-arm64-rpi4-v3.6.0-k3sv1.28.2+k3s1-initrd`
...
- `kairos-ubuntu-23.04-core-amd64-generic-v3.6.0.ipxe`
- `kairos-ubuntu-23.04-core-amd64-generic-v3.6.0-ipxe.iso`
- `kairos-ubuntu-23.04-core-amd64-generic-v3.6.0-ipxe-usb.img`
...
- `kairos-alpine-3.18-core-arm64-generic-v3.6.0-trivy.sarif`
- `kairos-alpine-3.18-core-arm64-generic-v3.6.0-grype.json`
...
- <OCICode variant="core" kairosVersion="v3.6.0" />
...
- <OCICode variant="core" arch="arm64" model="rpi4" suffix="img" kairosVersion="v3.6.0" />
