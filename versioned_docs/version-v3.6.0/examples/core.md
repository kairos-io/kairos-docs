...
install:
 ...
 source: "oci:{{< OCI variant="standard" kairosVersion="v3.6.0" k3sVersion="v1.33.5+k3s1"  >}}"
```

:::tip Note
Looking to install from a private registry OCI image? Check the [Private registry auth](/docs/v3.6.0/advanced/private_registry_auth/) page.
:::


Once you've chosen your image, you can move on to the installation process by following the steps outlined in our [Installation](/docs/v3.6.0/installation/) documentation.
...
- We set `install.source` to the container image that we want to deploy. This can be an image from [our support matrix](/docs/v3.6.0/reference/image_matrix/), a [custom image](/docs/v3.6.0/advanced/customizing/) or an [image from scratch](/docs/v3.6.0/reference/build-from-scratch/).
...
You can also refer our [troubleshooting](/docs/v3.6.0/reference/troubleshooting/) document if you are facing any issue while following the installation process.
