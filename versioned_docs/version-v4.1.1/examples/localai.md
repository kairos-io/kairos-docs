...
To get started, you'll need to use standard images, which include k3s. Follow the [Installation](../../installation) documentation, and use the following configuration:
