...
sidebar_label: "Encrypting User Data with Kairos"
sidebar_position: 5
...
An example on how to test this feature locally, can be found [in this document](https://github.com/kairos-io/kcrypt-challenger/blob/main/mdns-notes).
