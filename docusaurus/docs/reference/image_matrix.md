...
| **Flavor**      | repository                                      |
|-----------------|-------------------------------------------------|
| **Alpine**      | [quay.io/kairos/alpine](https://quay.io/repository/kairos/alpine)     |
| **Debian**      | [quay.io/kairos/debian](https://quay.io/repository/kairos/debian)     |
| **Fedora**      | [quay.io/kairos/fedora](https://quay.io/repository/kairos/fedora)     |
| **openSUSE**    | [quay.io/kairos/opensuse](https://quay.io/repository/kairos/opensuse)   |
| **Ubuntu**      | [quay.io/kairos/ubuntu](https://quay.io/repository/kairos/ubuntu)     |
| **Rocky Linux** | [quay.io/kairos/rockylinux](https://quay.io/repository/kairos/rockylinux) |
...
For example: <!-- OCI Image: quay.io/kairos/[flavor]-[variant]:[version] -->. More about Kairos naming conventions [here](.././artifacts).
...
docker run -ti --rm -v $PWD:/image gcr.io/go-containerregistry/crane export "<!-- Hugo shortcode: oci variant="core" arch="arm64" model="rpi4" suffix="img" -->" - | tar -xvf -
```
...
See the [kairos-factory.md](kairos-factory) page for more info.
...
Kairos releases contains also the __framework__ assets that can be used to [build Kairos images from Scratch](../../reference/build-from-scratch).
...
## Service Billing Of Materials (SBOM)
  ...
  ```bash
  https://github.com/kairos-io/kairos/releases/download/latest/<!-- Hugo shortcode: image variant="core" suffix="-sbom.spdx.json"  -->
  ```

 is the SBOM for the core <!-- Hugo shortcode: flavorCode  --> image.
