...
- Use [AuroraBoot](/docs/v3.5.7/Reference/auroraboot/)

Generic hardware based netbooting is out of scope for this document.
Below we give instructions on how to use the Kairos release artifacts to netboot and how to use [AuroraBoot](/docs/v3.5.7/Reference/auroraboot/) to boot from network.
...
[AuroraBoot](/docs/v3.5.7/Reference/auroraboot/) is a Kairos convinience tool that can be used to quickly deploy Kairos from Network with zero-touch configuration, for instance:
...
Will netboot the {{<ociCode variant="standard">}} image. You can find more details in the [AuroraBoot documentation section](/docs/v3.5.7/Reference/auroraboot/).
