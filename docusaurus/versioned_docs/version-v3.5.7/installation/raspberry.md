...
Extract the `img` file from a container image as described [in this page](/docs/v3.5.7/reference/image_matrix/)
...
You can push additional `cloud config` files. For a full reference check out the [docs](/docs/v3.5.7/reference/configuration/) and also [configuration after-installation](/docs/v3.5.7/advanced/after-install/)
