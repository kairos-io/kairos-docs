...
:::tip Note
Looking to install from a private registry OCI image? Check the [Private registry auth](/docs/v3.5.7/Advanced/private_registry_auth/) page.
:::


Once you've chosen your image, you can move on to the installation process by following the steps outlined in our [Installation](/docs/v3.5.7/Installation/) documentation.
...
- We set `install.source` to the container image that we want to deploy. This can be an image from [our support matrix](/docs/v3.5.7/Reference/image_matrix/), a [custom image](/docs/v3.5.7/Advanced/customizing/) or an [image from scratch](/docs/v3.5.7/Reference/build-from-scratch/).
...
You can also refer our [troubleshooting](/docs/v3.5.7/Reference/troubleshooting/) document if you are facing any issue while following the installation process.
