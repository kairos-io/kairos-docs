...
The Image support matrix in [here](/docs/v3.5.7/Reference/image_matrix/) lists all the container images built from our CI on every release of Kairos.
...
For upgrading to a container image see [manual upgrades](/docs/v3.5.7/Upgrade/manual/) and [kubernetes upgrades](/docs/v3.5.7/Upgrade/kubernetes/).

## See also

- [ISO remastering](/docs/v3.5.7/Installation/automated/#iso-remastering)
