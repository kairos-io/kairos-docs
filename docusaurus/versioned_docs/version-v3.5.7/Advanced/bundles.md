...
You can read more [here](/docs/v3.5.7/Advanced/sys-extensions/).
...
Bundles can carry also binaries that can be overlayed in the rootfs while [building images](/docs/v3.5.7/Advanced/build/).
