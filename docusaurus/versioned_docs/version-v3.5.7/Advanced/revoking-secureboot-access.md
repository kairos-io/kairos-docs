...
booting on their hardware in the context of ["Trusted Boot"](/docs/v3.5.7/Architecture/trustedboot/).
...
If you followed [the instructions to create signing keys](/docs/v3.5.7/Installation/trustedboot/#key-generation), you should have a directory with a `db.pem` certificate. This is the certificate
...
As described in the ["Trusted Boot"](/docs/v3.5.7/Architecture/trustedboot/) documentation page,
...
The "fallback" image will be upgraded on the next upgrade. Read the ["Container based"](/docs/v3.5.7/Architecture/container/)
