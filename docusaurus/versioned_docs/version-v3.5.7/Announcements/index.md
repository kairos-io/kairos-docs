...
Starting on v3.2.0, we have agreed on the order the config dirs are read upon. See the [cloud-config](/docs/v3.5.7/Architecture/cloud-init/#configuration-order) page for more info.
:::
