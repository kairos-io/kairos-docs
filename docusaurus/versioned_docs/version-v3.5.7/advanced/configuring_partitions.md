...
Kairos configuration mechanism for partitions is based on the [cloud-config](/docs/v3.5.7/reference/configuration/) file 
...
For more information about the full config available for partitions and extra partitions see the full [cloud-config page](/docs/v3.5.7/reference/configuration/)
