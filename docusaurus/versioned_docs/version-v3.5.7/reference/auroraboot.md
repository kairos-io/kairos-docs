...
:::info Note
This is the reference documentation for AuroraBoot. For a complete guide on creating custom cloud images, including how to use AuroraBoot in the context of a full workflow, see [Creating Custom Cloud Images](/docs/v3.5.7/advanced/creating_custom_cloud_images/).
:::
...
1. Select the release of Kairos that you want to deploy and optionally a cloud config (see also our [examples](/docs/v3.5.7/examples/))
...
To use a container image, you can use [the Kairos released images](/docs/v3.5.7/reference/image_matrix/) or [customized](/docs/v3.5.7/advanced/customizing/) by specifying `--set container_image` instead with the container image of choice.
...
You can use [the Kairos released images](/docs/v3.5.7/reference/image_matrix/) or [your own](/docs/v3.5.7/advanced/customizing/).
...
Create a cloud config file, see [our documentation](/docs/v3.5.7/examples/) for ready-to use examples, but a minimal configuration that automatically installs, and allows us to login afterward can be the following:
...
| `flavor`              | The Kairos flavor to use. See [the Kairos support matrix](/docs/v3.5.7/reference/image_matrix/) for a list.                                                                                                                                                 |
...
See the [Airgap example](/docs/v3.5.7/examples/airgap/) in the [examples section](/docs/v3.5.7/examples/).
