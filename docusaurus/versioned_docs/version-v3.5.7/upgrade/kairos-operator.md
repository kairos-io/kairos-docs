...
- [Upgrading Kairos with the operator](/docs/v3.5.7/upgrade/kubernetes/)
- [Trusted Boot upgrades](/docs/v3.5.7/upgrade/trustedboot/)
- [Manual upgrades](/docs/v3.5.7/upgrade/manual/)
