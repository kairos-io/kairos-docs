...
:::warning Deprecated
The system-upgrade-controller approach is deprecated. We recommend using the [Kairos operator](/docs/v3.6.0/Upgrade/kairos-operator/) instead, which provides a more integrated and Kairos-specific way to manage upgrades and operations.
:::
