...
The Image support matrix in [here](/docs/v3.6.0/reference/image_matrix/) lists all the container images built from our CI on every release of Kairos.
...
KAIROS_PRETTY_NAME="kairos-core-@flavor v3.6.0"
...
$ docker run -v $PWD:/cOS -v /var/run/docker.sock:/var/run/docker.sock -i --rm quay.io/kairos/auroraboot:v0.13.0 --debug build-iso --name "custom-iso" --date=false --output /cOS/ custom-image
 > ...
 > ...
...
For upgrading to a container image see [manual upgrades](/docs/v3.6.0/upgrade/manual/) and [kubernetes upgrades](/docs/v3.6.0/upgrade/kubernetes/).

## See also

- [ISO remastering](/docs/v3.6.0/installation/automated/#iso-remastering)
