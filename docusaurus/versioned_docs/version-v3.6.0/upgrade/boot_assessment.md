...
- "Trusted boot" installations:
  The same option are included in [the default cmdline](https://github.com/kairos-io/AuroraBoot/blob/5d5bd2742520d654cd1bb865864acc3d37c43e57/pkg/constants/constants.go#L77), when an image is built with aurorabootk([trusted boot docs](/docs/v3.6.0/installation/trustedboot/)).
...
- "Trusted boot" installations:
  The same options are included in [the default cmdline](https://github.com/kairos-io/AuroraBoot/blob/5d5bd2742520d654cd1bb865864acc3d37c43e57/pkg/constants/constants.go#L77), when an image is built with auroraboot ([trusted boot docs](/docs/v3.6.0/installation/trustedboot/)).
