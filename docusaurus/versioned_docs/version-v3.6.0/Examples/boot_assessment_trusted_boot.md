...
For more information about cloud-init in Kairos, see the [Cloud-Init Architecture](/docs/v3.6.0/Architecture/cloud-init/) guide.
For more information about stage modules, see the [Stage Modules Reference](/docs/v3.6.0/Reference/stage_modules/).
