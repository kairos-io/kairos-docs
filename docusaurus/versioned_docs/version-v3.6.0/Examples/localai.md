...
To get started, you'll need to use standard images, which include k3s. Follow the [Installation](/docs/v3.6.0/Installation/) documentation, and use the following configuration:
