...
To install Kairos in ["Trusted Boot Mode"](/docs/v3.6.0/Architecture/trustedboot/) the machine needs to meet the following requirements:
...
IMAGE="${IMAGE:-quay.io/kairos/ubuntu:24.04-core-amd64-generic-v3.6.0-uki}"
