...
You can read more [here](/docs/v3.6.0/advanced/sys-extensions/).
...
Bundles can carry also binaries that can be overlayed in the rootfs while [building images](/docs/v3.6.0/advanced/build/).
