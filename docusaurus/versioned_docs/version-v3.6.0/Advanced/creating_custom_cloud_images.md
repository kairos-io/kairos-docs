...
See the [Customizing Images](/docs/v3.6.0/Advanced/customizing/) guide for detailed instructions.
...
:::info Note
For more details about AuroraBoot options and configurations, see the [AuroraBoot documentation](/docs/v3.6.0/Reference/auroraboot/).
:::
...
### AWS
To install on AWS, follow the [AWS Guide](/docs/v3.6.0/Installation/aws/).

### Google Cloud
To install on Google Cloud, follow the [Google Cloud Installation Guide](/docs/v3.6.0/Installation/gce/).

### Microsoft Azure
For Azure deployments, see the [Azure Installation Guide](/docs/v3.6.0/Installation/azure/).
...
- [Customizing Images](/docs/v3.6.0/Advanced/customizing/)
- [AuroraBoot Reference](/docs/v3.6.0/Reference/auroraboot/)
- [Cloud Configuration Reference](/docs/v3.6.0/Reference/configuration/) 