...
- A core OS image release for each flavor in ISO, qcow2, and other similar formats (see [the list of supported distributions](/docs/v3.7.2/Reference/image_matrix/)) provided for user convenience
...
To build Kairos from scratch, see [the documentation](/docs/v3.7.2/Reference/build-from-scratch/) section.
