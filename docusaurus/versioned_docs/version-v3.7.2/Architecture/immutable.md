...
:::info
You can add additional paths to the persistent partition by using the [bind_mounts configuration option](/docs/v3.7.2/Reference/configuration/). This is useful for storing additional data that you want to persist across reboots or upgrades.
:::
