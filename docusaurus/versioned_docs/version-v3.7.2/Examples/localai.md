...
To get started, you'll need to use standard images, which include k3s. Follow the [Installation](/docs/v3.7.2/Installation/) documentation, and use the following configuration:
