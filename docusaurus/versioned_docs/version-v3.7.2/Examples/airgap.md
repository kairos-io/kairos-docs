...
If you want to create an [airgap K3s installation](https://docs.k3s.io/installation/airgap), Kairos provides a convenient way to do so using AuroraBoot. In this guide, we will go through the process of creating a custom ISO of Kairos that contains a configuration file and a [bundle](/docs/v3.7.2/Advanced/bundles/) that executes preparatory steps after installation. The bundle will overlay new files in the system and prepare the node for having an airgapped K3s installation.
...
2. Build the ISO with [AuroraBoot](/docs/v3.7.2/Reference/auroraboot/) by running the following command:
...
docker run -v $PWD/config.yaml:/config.yaml \
             ...
             -v $PWD/data:/tmp/data \
             --rm -ti quay.io/kairos/auroraboot:v0.14.0 \
...
- [Customize the OS image](/docs/v3.7.2/Advanced/customizing/)
- [Create ISOs with Kubernetes](/docs/v3.7.2/Installation/automated/#kubernetes)
- [Bundles reference](/docs/v3.7.2/Advanced/bundles/)
- [System extensions](/docs/v3.7.2/Advanced/sys-extensions/)
