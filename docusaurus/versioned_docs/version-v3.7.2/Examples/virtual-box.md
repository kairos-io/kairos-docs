...
sidebar_label: "Trusted Boot in Virtual Box"
description: This section describes how to use Virtual Box to boot Kairos in "Trusted boot" mode
---

To install Kairos in ["Trusted Boot Mode"](/docs/v3.7.2/Architecture/trustedboot/) the machine needs to meet the following requirements:
...
IMAGE="${IMAGE:-quay.io/kairos/ubuntu:24.04-core-amd64-generic-v3.7.2-uki}"
