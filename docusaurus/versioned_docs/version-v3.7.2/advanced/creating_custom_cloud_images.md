...
sidebar_label: "Creating Custom Cloud Images"
sidebar_position: 1
...
See the [Customizing Images](/docs/v3.7.2/advanced/customizing/) guide for detailed instructions.
...
:::info Note
For more details about AuroraBoot options and configurations, see the [AuroraBoot documentation](/docs/v3.7.2/reference/auroraboot/).
:::
...
### AWS
To install on AWS, follow the [AWS Guide](/docs/v3.7.2/installation/aws/).

### Google Cloud
To install on Google Cloud, follow the [Google Cloud Installation Guide](/docs/v3.7.2/installation/gce/).

### Microsoft Azure
For Azure deployments, see the [Azure Installation Guide](/docs/v3.7.2/installation/azure/).
...
- [Customizing Images](/docs/v3.7.2/advanced/customizing/)
- [AuroraBoot Reference](/docs/v3.7.2/reference/auroraboot/)
- [Cloud Configuration Reference](/docs/v3.7.2/reference/configuration/) 
