...
:::tip Note
This method differs from the ones documented in the [Auroraboot](/docs/v3.7.2/reference/auroraboot/) section: this method is suitable if you need to create appliances that have to run a full-installation. AuroraBoot will create instead images pre-installed which will skip the usual Kairos installation process in runtime
:::

For more information about AuroraBoot, see the [AuroraBoot Reference](/docs/v3.7.2/reference/auroraboot/).
