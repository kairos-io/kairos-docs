...
```bash
curl -L https://github.com/kairos-io/provider-kairos/releases/download/<!-- Hugo shortcode: providerVersion -->/kairosctl-.<!-- Hugo shortcode: providerVersion -->-.linux-.amd64.tar.gz -o - | tar -xvzf - -C .
```
